...
StudiesPage studiesPage = new StudiesPage(false);
    ...
    @Test(priority = 1, dataProvider = "", dataProviderClass =  DataProviderFactory.class)
    ...
    public void Edit_MyStudy_Name()  {
        studiesPage.send_FilterStudyName("");
        studiesPage.clickon_Edit_MyStudy("");
        studiesPage.send_EditStudyName("");
...
//        studiesPage.select_StudyFile("NoteNew");
