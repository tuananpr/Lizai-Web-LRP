...
public class StudiesPage extends BaseLizAIPages {
    ...
    private final String xpath_Study_ListStudyCode = "//app-study-list//table//td//p/small";
    ...
    public void clickon_Edit_MyStudy(String studyCode){
        for (int i = 0; i < listOfElementsStudyCode.getNumberOfElement(); i++) {
            if(listOfElementsStudyCode.getElement(i).getText().contains(studyCode)){
                listOfElementsStudyCode.getElement(i).findElements(By.xpath(xpath_list_icon_Study_Edit)).get(i).click();
            }
        }
        waitForJSToComplete();
    }
